...
class ReferCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 90.w,
      padding: EdgeInsets.all(4.w),  // Adjust spacing based on screen size
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(15),
        gradient: LinearGradient(
          colors: [Color(0xFF72A8FF), Color(0xFFB9D1FF)], // Light blue gradient background
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 5.w, vertical: 1.h),  // Button padding
                    child: Text(
                      "Refer now",
                      style: TextStyle(
                        fontSize: 8.sp,  // Font size according to screen size
